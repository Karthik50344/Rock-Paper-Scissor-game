...
b1 = Button(frame1, text="✊",bg="white",fg="red",font="normal 20 bold", width=7,command=isrock)
b1.grid(row=1, column=0, pady=2)
b2 = Button(frame1, text="✋",bg="white",fg="red",font="normal 20 bold", width=7,command=ispaper)
b2.grid(row=1, column=1, pady=2)
b3 = Button(frame1, text="✌",bg="white",fg="red",font="normal 20 bold", width=7,command=isscissor)
